<?php /* /opt/lampp/htdocs/sispenka/resources/views/home.blade.php */ ?>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?php echo e(count($ternilai)); ?></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?php echo e(count($belumnilai)); ?></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?php echo $tertinggi; ?></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?php echo $terendah; ?></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
      ...
      <div class="col-md-12">
        <div class="box box-info">
          ...
          <div class="box-footer">
            <button type="button" class="btn btn-md btn-default insertKriteria btn-block text-center" data-href="<?php echo e(route('kriteria.create')); ?>"><i class="fa fa-plus"></i>&nbsp&nbsp&nbspTambah Kriteria</button>
          </div>
