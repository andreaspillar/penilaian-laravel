        ...
        <div class="box box-info">
          <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
              <button type="button" class="btn btn-sm btn-default insertKriteria" data-href="{{route('kriteria.create')}}"><i class="fa fa-plus"></i>&nbsp&nbsp&nbsp<b>Tambah Kriteria</b></button>
            </div>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
